...
export function parseMetadata(raw) {
  if (!raw) return { mentions: [], priority: 'normal', task_status: null, evidence: null, discussion_phase: null };
  try {
  ...
  } catch { return { mentions: [], priority: 'normal', task_status: null, evidence: null, discussion_phase: null }; }
}
